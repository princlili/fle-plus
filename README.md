...
At the core of FLE+ is a more ambitious question:
**what do you care about most, as a human being?**
And can you begin to think, build, or create something around that —
in a language you barely master?
...
- Human first, language second
- Open to digital, analog, and hybrid forms

## What this repository documents

Observations from real learning situations (anonymized).
Patterns, failures, adjustments, surprises.
